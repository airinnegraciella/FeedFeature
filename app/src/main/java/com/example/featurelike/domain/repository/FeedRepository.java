package com.example.featurelike.domain.repository;
...
import com.example.featurelike.data.source.model.remote.response.ResponseLikeFeed;
...
//    void getFeedPagination(int empId, int page, int limit, ICallback<ResponseGetFeedPagination> callback );
...
//    void getFeedCommentPagination(int employeeId, int feedId, int page, int limit, ICallback<ResponseGetFeedCommentPagination> callback);
...
//    void getFeedLikePagination(int feedId, int page, int limit, ICallback<ResponseGetFeedLikePagination> callback);
